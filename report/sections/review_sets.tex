...
\begin{figure}[H]
	...
	\caption{Raport entre $\sigma(x)$ et $\pi(x)$. La courbe représente la médiane de chaque groupe d'ensemble. La surface autour de la courbe montre l'écart entre les premiers et troisièmes quartiles. }
